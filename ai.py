...
def open_application(text):
    if "bật ứng dụng google" in text:
        speak("Mở Google Chrome")
        time.sleep(2)
        os.startfile("C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe")
    elif "bật ứng dụng word" in text:
        speak("Mở Microsoft Word")
        time.sleep(2)
        os.startfile("C:\\Program Files (x86)\\Microsoft Office\\root\\Office16\\WINWORD.EXE")
    elif "bật ứng dụng excel" in text:
        speak("bật ứng dụng Microsoft Excel")
        time.sleep(2)
...
def assistant():
    ...
    if name:
        ...
        time.sleep(5)
        speak("Bạn cần Bot David có thể giúp gì ạ?")
        time.sleep(3)
        while True:
            text = get_text()
            if not text:
